...
class Cards extends Component {
    state = {
        Heads :[
            ...
            twitterUrl:"https://twitter.com/Vaibhav21409562",
            instaUrl:"https://www.instagram.com/vaibhavgupta_432/",
            linkedinUrl:"https://www.linkedin.com/in/vaibhav-gupta-908539172/",
            },
    ...
    render() { 
        return (
            <div>
                {/* {this.state.Heads.map(head => <Card 
                    imageUrl  = {head.imageUrl}
                    name = {head.name}
                    designation = {head.designation}
                    info = {head.info}
                    facebookUrl = {head.facebookUrl}
                    twitterUrl = {head.twitterUrl}
                    instaUrl = {head.instaUrl}
                ...
                <section className="text-gray-400 bg-gray-900 body-font">
                    <div className="container px-5 py-24 mx-auto">
                        ...
                        <h1 className="text-2xl font-medium title-font mb-4 text-white">HEADS</h1>
